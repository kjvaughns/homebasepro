        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                Payment received and payout notifications
              </p>
            </div>
            <Switch
              id="payments"
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              <Label htmlFor="reminders">Job Reminders</Label>
              <p className="text-sm text-muted-foreground">
                Upcoming job reminders and deadlines
              </p>
            </div>
            <Switch
              id="reminders"
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground">
                New features and business tips
              </p>
            </div>
            <Switch
              id="marketing"
